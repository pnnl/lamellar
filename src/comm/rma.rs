...
pub(crate) trait WriteEpImpl: AsTypedFid<EpRawFid> {
    ...
    unsafe fn inject_write_impl<T: Copy, RT: Copy>(
        &self,
        buf: &[T],
        dest_addr: Option<&crate::MappedAddress>,
        mem_addr: RemoteMemoryAddress<RT>,
    ...
    unsafe fn inject_writedata_impl<T: Copy, RT: Copy>(
        &self,
        buf: &[T],
        data: u64,
        dest_addr: Option<&crate::MappedAddress>,
...
pub trait WriteEp {
    ...
    ///  
    /// Equivalent to `fi_inject`.
    unsafe fn inject_write_to<T: Copy, RT: Copy>(
        &self,
        buf: &[T],
        dest_addr: &crate::MappedAddress,
        mem_addr: RemoteMemoryAddress<RT>,
    ...
    ///  
    /// Equivalent to `fi_inject_writedata`.
    unsafe fn inject_writedata_to<T: Copy, RT: Copy>(
        &self,
        buf: &[T],
        data: u64,
        dest_addr: &crate::MappedAddress,
...
pub trait ConnectedWriteEp {
    ...
    unsafe fn inject_write<T: Copy, RT: Copy>(
        &self,
        buf: &[T],
        mem_addr: RemoteMemoryAddress<RT>,
        mapped_key: &MappedMemoryRegionKey,
    ...
    unsafe fn inject_writedata<T: Copy, RT: Copy>(
        &self,
        buf: &[T],
        data: u64,
        mem_addr: RemoteMemoryAddress<RT>,
