use crate::{iovec, mr::DataDescriptor, Address};
...
impl Msg {
    ...
    pub fn new<T>(iov: &[iovec::IoVec<T>], desc: &mut [impl DataDescriptor], addr: Address) -> Self {
        Msg {
...
impl MsgTagged {
    pub fn new<T>(iov: &[iovec::IoVec<T>], desc: &mut [impl DataDescriptor], addr: Address, data: u64, tag: u64, ignore: u64) -> Self {
...
impl MsgRma {
    pub fn new<T, T0>(iov: &[iovec::IoVec<T>], desc: &mut [impl DataDescriptor], addr: Address, rma_iov: &[iovec::RmaIoVec], context: &mut T0, data: u64) -> Self {
        Self {
