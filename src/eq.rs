...
impl CommandQueueAttr {
    ...
    pub fn wait_set(&mut self, wait_set: &Wait) -> &mut Self {
...
use crate::{FID, enums::AvType, AvAttr};
#[test]
...
fn eq_open_close_sizes() {
    ...
    for i in -1..17 {
        ...
        let mut eq_attr = crate::eq::EqAttr::new();
        eq_attr.size(size);
