...
use crate::fid::AsFid;
use crate::{cq::WaitObjectRetrieve, domain::DomainImplT, enums::WaitObjType, fid::{self, AsRawFid, AsRawTypedFid, AsTypedFid, CntrRawFid, OwnedCntrFid, RawFid}, utils::check_error, MyRc};
