...
pub(crate) trait AsyncTagRecvEpImpl: AsyncRxEp + TagRecvEpImpl {
    async fn trecv_async_impl<T>(&self, buf: &mut [T], desc: &mut impl DataDescriptor, mapped_addr: Option<&MappedAddress>, tag: u64, ignore:u64, user_ctx: Option<*mut std::ffi::c_void>) -> Result<SingleCompletion, crate::error::Error> {
        ...
        self.trecv_impl(buf, desc, mapped_addr, tag, ignore, Some(&mut async_ctx as *mut AsyncCtx as *mut std::ffi::c_void))?;
	...
	async fn trecvv_async_impl<'a>(&self, iov: &[crate::iovec::IoVecMut<'a>], desc: &mut [impl DataDescriptor], src_mapped_addr: Option<&MappedAddress>, tag: u64, ignore:u64, user_ctx : Option<*mut std::ffi::c_void>) -> Result<SingleCompletion, crate::error::Error> { 
        let mut async_ctx = AsyncCtx{user_ctx};
        self.trecvv_impl(iov, desc, src_mapped_addr, tag, ignore, Some(&mut async_ctx as *mut AsyncCtx as *mut std::ffi::c_void))?;
        let cq = self.retrieve_rx_cq();
        cq.wait_for_ctx_async(&mut async_ctx).await
    }

    async fn trecvmsg_async_impl<'a>(&self, mut msg: Either<&mut crate::msg::MsgTaggedMut<'a>, &mut crate::msg::MsgTaggedConnectedMut<'a>>, options: TaggedRecvMsgOptions) -> Result<SingleCompletion, crate::error::Error> {
        ...
        let imm_msg = match msg {
            Either::Left(ref mut msg) => {msg.get_mut().context = (&mut async_ctx as *mut AsyncCtx).cast(); Either::<&MsgTaggedMut, &MsgTaggedConnectedMut>::Left(msg)},
            Either::Right(ref mut msg) => {msg.get_mut().context = (&mut async_ctx as *mut AsyncCtx).cast(); Either::<&MsgTaggedMut, &MsgTaggedConnectedMut>::Right(msg)},
        };
...
pub trait AsyncTagRecvEp {
    ...
    fn trecvmsg_from_async<'a>(&self, msg: &mut crate::msg::MsgTaggedMut<'a>, options: TaggedRecvMsgOptions) -> impl std::future::Future<Output = Result<SingleCompletion, crate::error::Error>> ;
    fn trecvmsg_async<'a>(&self, msg: &mut crate::msg::MsgTaggedConnectedMut<'a>, options: TaggedRecvMsgOptions) -> impl std::future::Future<Output = Result<SingleCompletion, crate::error::Error>> ;
}
...
impl<EP: AsyncTagRecvEpImpl> AsyncTagRecvEp for EP {
    ...
    #[inline]
    async fn trecvmsg_from_async<'a>(&self, msg: &mut crate::msg::MsgTaggedMut<'a>, options: TaggedRecvMsgOptions) -> Result<SingleCompletion, crate::error::Error> {
        self.trecvmsg_async_impl(Either::Left(msg), options).await
    }

    #[inline]
    async fn trecvmsg_async<'a>(&self, msg: &mut crate::msg::MsgTaggedConnectedMut<'a>, options: TaggedRecvMsgOptions) -> Result<SingleCompletion, crate::error::Error> {
...
pub(crate) trait AsyncTagSendEpImpl: AsyncTxEp + TagSendEpImpl {
    async fn tsend_async_impl<T>(&self, buf: &[T], desc: &mut impl DataDescriptor, mapped_addr: Option<&MappedAddress>, tag:u64, user_ctx: Option<*mut std::ffi::c_void>) -> Result<SingleCompletion, crate::error::Error> {
        let mut async_ctx = AsyncCtx{user_ctx};
        self.tsend_impl(buf, desc, mapped_addr, tag, Some(&mut async_ctx as *mut AsyncCtx as *mut std::ffi::c_void))?;
	...
	async fn tsendv_async_impl<'a>(&self, iov: &[crate::iovec::IoVec<'a>], desc: &mut [impl DataDescriptor], dest_mapped_addr: Option<&MappedAddress>, tag:u64, user_ctx: Option<*mut std::ffi::c_void>) -> Result<SingleCompletion, crate::error::Error> {
        let mut async_ctx = AsyncCtx{user_ctx};
        self.tsendv_impl(iov, desc, dest_mapped_addr, tag, Some(&mut async_ctx as *mut AsyncCtx as *mut std::ffi::c_void))?;
        let cq = self.retrieve_tx_cq();
        cq.wait_for_ctx_async(&mut async_ctx).await
    }

    async fn tsendmsg_async_impl<'a>(&self, mut msg: Either<&mut crate::msg::MsgTagged<'a>, &mut crate::msg::MsgTaggedConnected<'a>>, options: TaggedSendMsgOptions) -> Result<SingleCompletion, crate::error::Error> {
        let real_user_ctx = match msg {
            Either::Left(ref mut msg) => msg.get_mut().context,
            Either::Right(ref mut msg) => msg.get_mut().context,
        };
        ...
        let imm_msg = match msg {
            Either::Left(ref mut msg) => {msg.get_mut().context = (&mut async_ctx as *mut AsyncCtx).cast(); Either::<&MsgTagged, &MsgTaggedConnected>::Left(msg)},
            Either::Right(ref mut msg) => {msg.get_mut().context = (&mut async_ctx as *mut AsyncCtx).cast(); Either::<&MsgTagged, &MsgTaggedConnected>::Right(msg)},
        };
    ...
    async fn tsenddata_async_impl<T>(&self, buf: &[T], desc: &mut impl DataDescriptor, data: u64, mapped_addr: Option<&MappedAddress>, tag: u64, user_ctx: Option<*mut std::ffi::c_void>) -> Result<SingleCompletion, crate::error::Error> {
        let mut async_ctx = AsyncCtx{user_ctx};
        self.tsenddata_impl(buf, desc, data, mapped_addr, tag, Some(&mut async_ctx as *mut AsyncCtx as *mut std::ffi::c_void))?;
        let cq = self.retrieve_tx_cq();
        cq.wait_for_ctx_async(&mut async_ctx).await
    }
}
...
pub trait AsyncTagSendEp: TagSendEp {
    ...
    fn tsendmsg_async<'a>(&self, msg: &mut crate::msg::MsgTaggedConnected<'a>, options: TaggedSendMsgOptions) -> impl std::future::Future<Output = Result<SingleCompletion, crate::error::Error>>;
    fn tsendmsg_to_async<'a>(&self, msg: &mut crate::msg::MsgTagged<'a>, options: TaggedSendMsgOptions) -> impl std::future::Future<Output = Result<SingleCompletion, crate::error::Error>>;
...
impl<EP: AsyncTagSendEpImpl + TagSendEpImpl> AsyncTagSendEp for EP {
    ...
    #[inline]
    async fn tsendmsg_async<'a>(&self, msg: &mut crate::msg::MsgTaggedConnected<'a>, options: TaggedSendMsgOptions) -> Result<SingleCompletion, crate::error::Error> {
        self.tsendmsg_async_impl(Either::Right(msg), options).await
    }

    #[inline]
    async fn tsendmsg_to_async<'a>(&self, msg: &mut crate::msg::MsgTagged<'a>, options: TaggedSendMsgOptions) -> Result<SingleCompletion, crate::error::Error> {
