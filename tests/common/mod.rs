...
use libfabric::{cntr::{Counter, CounterBuilder}, cntroptions::CntrConfig, cq::{CompletionQueue, CompletionQueueBuilder, CtxEntry, EntryFormat, UnspecEntry}, cqoptions::{CqConfig,Options}, domain, ep::{EndpointBuilder, Endpoint, Address, PassiveEndpoint}, eq::EventQueueBuilder, eqoptions::EqConfig, fabric, Context, Waitable, infocapsoptions::{RmaCap, TagDefaultCap, MsgDefaultCap, RmaDefaultCap, RmaWriteOnlyCap, self}, MappedAddress, info::{InfoHints, Info, InfoEntry, InfoCapsImpl}, mr::{default_desc, MemoryRegionKey, MappedMemoryRegionKey}, MSG, RMA, TAG, enums::AVOptions};
use libfabric::enums;
pub enum CompMeth {
    Spin,
    Sread,
...
pub enum CqType {
    Spin(CompletionQueue<Options<libfabric::cqoptions::WaitNone, libfabric::cqoptions::Off>, CtxEntry>),
    Sread(CompletionQueue<Options<libfabric::cqoptions::WaitNoRetrieve, libfabric::cqoptions::Off>, CtxEntry>),
    WaitSet(CompletionQueue<Options<libfabric::cqoptions::WaitNoRetrieve, libfabric::cqoptions::Off>, CtxEntry>),
    WaitFd(CompletionQueue<Options<libfabric::cqoptions::WaitRetrieve, libfabric::cqoptions::On>, CtxEntry>),
    WaitYield(CompletionQueue<Options<libfabric::cqoptions::WaitNoRetrieve, libfabric::cqoptions::Off>, CtxEntry>),
}
...
#[allow(clippy::too_many_arguments)]
pub fn ft_post_rma_inject<CQ: CqConfig, E: RmaWriteOnlyCap, Format: EntryFormat>(gl_ctx: &mut TestsGlobalCtx, rma_op: &RmaOp, offset: usize, size: usize, remote: &RmaInfo, ep: &libfabric::ep::Endpoint<E>, tx_cq: &CompletionQueue<CQ, Format>) {
...
#[allow(clippy::too_many_arguments)]
pub fn ft_post_rma<CQ: CqConfig, E: RmaDefaultCap, Format: EntryFormat>(gl_ctx: &mut TestsGlobalCtx, rma_op: &RmaOp, offset: usize, size: usize, remote: &RmaInfo, ep: &libfabric::ep::Endpoint<E>, data_desc: &mut impl libfabric::mr::DataDescriptor, tx_cq: &CompletionQueue<CQ, Format>) {
...
pub fn msg_post<CQ: CqConfig, E: MsgDefaultCap, Format: EntryFormat>(op: SendOp, tx_seq: &mut u64, tx_cq_cntr: &mut u64, ctx : &mut Context, remote_address: &Option<MappedAddress>, tx_cq: &CompletionQueue<CQ, Format>, ep: &libfabric::ep::Endpoint<E>, data_desc: &mut Option<libfabric::mr::MemoryRegionDesc>, base: &mut [u8], data: u64) {
    match op {
        SendOp::MsgSend => {
...
pub fn msg_post_recv<CQ: CqConfig, E: MsgDefaultCap, Format: EntryFormat>(op: RecvOp, rx_seq: &mut u64, rx_cq_cntr: &mut u64, ctx : &mut Context, remote_address: &Option<MappedAddress>,  rx_cq: &CompletionQueue<CQ, Format>, ep: &libfabric::ep::Endpoint<E>, data_desc: &mut Option<libfabric::mr::MemoryRegionDesc>, base: &mut [u8], _data: u64) {
    match op {
        RecvOp::MsgRecv => {
            todo!()
        }
...
pub fn tagged_post<CQ: CqConfig,E: TagDefaultCap, Format: EntryFormat>(op: TagSendOp, tx_seq: &mut u64, tx_cq_cntr: &mut u64, ctx : &mut Context, remote_address: &Option<MappedAddress>,  ft_tag: u64, tx_cq: &CompletionQueue<CQ, Format>, ep: &libfabric::ep::Endpoint<E>, data_desc: &mut Option<libfabric::mr::MemoryRegionDesc>, base: &mut [u8], data: u64) {
    match op {
...
pub fn tagged_post_recv<CQ: CqConfig,E: TagDefaultCap, Format: EntryFormat>(op: TagRecvOp, rx_seq: &mut u64, rx_cq_cntr: &mut u64, ctx : &mut Context, remote_address: &Option<MappedAddress>, ft_tag: u64,  rx_cq: &CompletionQueue<CQ, Format>, ep: &libfabric::ep::Endpoint<E>, data_desc: &mut Option<libfabric::mr::MemoryRegionDesc>, base: &mut [u8], _data: u64) {
    match op {
...
#[allow(clippy::too_many_arguments)]
pub fn ft_post_tx<CQ: CqConfig, M: MsgDefaultCap, T: TagDefaultCap, Format: EntryFormat>(gl_ctx: &mut TestsGlobalCtx, ep: &EndpointCaps<M, T>, size: usize, data: u64, data_desc: &mut Option<libfabric::mr::MemoryRegionDesc>, tx_cq: &CompletionQueue<CQ, Format>) {
...
#[allow(clippy::too_many_arguments)]
pub fn ft_post_rx<CQ: CqConfig, M: MsgDefaultCap, T: TagDefaultCap, Format: EntryFormat>(gl_ctx: &mut TestsGlobalCtx, ep: &EndpointCaps<M, T>, mut size: usize, _data: u64, data_desc: &mut Option<libfabric::mr::MemoryRegionDesc>, rx_cq: &CompletionQueue<CQ, Format>) {
...
pub fn ft_post_inject<CQ: CqConfig, M: MsgDefaultCap, T: TagDefaultCap, Format: EntryFormat>(gl_ctx: &mut TestsGlobalCtx, ep: &EndpointCaps<M, T>, size: usize, tx_cq: &libfabric::cq::CompletionQueue<CQ, Format>) {
    // size += ft_tx_prefix_size(info);
    let buf = &mut gl_ctx.buf[gl_ctx.tx_buf_index..gl_ctx.tx_buf_index+size];
    let fi_addr = &gl_ctx.remote_address;
...
pub fn ft_progress<CQ: CqConfig, Format: EntryFormat>(cq: &libfabric::cq::CompletionQueue<CQ, Format>, _total: u64, cq_cntr: &mut u64) {
    let ret = cq.read(1);
    match ret {
        Ok(_) => {*cq_cntr += 1;},
        Err(ref err) => {
...
pub fn ft_spin_for_comp<CQ: CqConfig, Format: EntryFormat>(cq: &libfabric::cq::CompletionQueue<CQ, Format>, curr: &mut u64, total: u64, _timeout: i32, _tag: u64) {
...
pub fn ft_wait_for_comp<CQ: CqConfig + Waitable, Format: EntryFormat>(cq: &libfabric::cq::CompletionQueue<CQ, Format>, curr: &mut u64, total: u64, _timeout: i32, _tag: u64) {
